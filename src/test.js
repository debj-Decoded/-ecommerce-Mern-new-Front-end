...
// const opt=(option.value,section.id)
// for(let c in opt){
//       console.log(c)
// }
...
//     checked:false
// }))
// function findProductsWithLessThan4Images(products) {
//       const productsWithLessThan4Images = [];
    
//       for (const product of products) {
//         if (product.images.length < 4) {
//           productsWithLessThan4Images.push(product);
//         }
//       }
    
//       return productsWithLessThan4Images;
//     }
...
const navigation = [
      ...
      // { name: 'Home', href: '/', admin: true },
       
    
//     console.log(navigation.map((e)=>(e[admin])))
